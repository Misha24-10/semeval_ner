...
from transformers import RemBertForTokenClassification, RemBertPreTrainedModel, RemBertModel
...
class RemBertForTokenBILSTMClassification(RemBertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
    ...
    def init_hidden(self, batch_size):
        return torch.zeros(NUM_LAYER*2, batch_size, hidden_size).to("cuda"), torch.zeros(NUM_LAYER*2, batch_size, hidden_size).to("cuda")
